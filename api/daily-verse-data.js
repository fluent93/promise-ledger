...
const expressions = [
  { phrase: "Let's circle back.", meaning: "나중에 다시 얘기하자, 다시 짚고 넘어가자." },
  { phrase: "Can you walk me through it?", meaning: "그거 차근차근 설명해줄래?" },
  ...
  { phrase: "I can live with that.", meaning: "그 정도면 괜찮아, 받아들일 수 있어." },
  ...
  { phrase: "Let's not make a big thing out of it.", meaning: "그걸 너무 크게 만들지는 말자." },
  { phrase: "We need to get ahead of this.", meaning: "이거 더 커지기 전에 선제적으로 대응해야 해." },
  ...
  { phrase: "Don't quote me on that.", meaning: "정확하다고 단정하진 마, 내 말 인용하지는 마." },
  { phrase: "That's not a dealbreaker.", meaning: "그게 결정적인 문제는 아니야." },
  { phrase: "Let's keep our options open.", meaning: "선택지를 열어두자." },
];
